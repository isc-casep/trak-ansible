...
\begin{frame}
  ...
  \lstinputlisting[language=bash,caption={Example sintax.}]
...
\begin{frame}
  ...
  \lstinputlisting[language=bash,caption={Example execution.}]
...
\begin{frame}
  ...
  \lstinputlisting[language=bash,caption={Example execution error.}]
{scripts/error.txt}
